...
import 'package:consciousleap/Questionnarie/Activity_page10.dart';
import 'package:flutter/material.dart';
import 'package:gradient_borders/box_borders/gradient_box_border.dart';

// I am good at managing the many responsibilities of my daily life Page


class Activity_page9 extends StatelessWidget{
  @override
          ...
          Column(
            ...
            children: [
              Padding(
                ...
                child:SizedBox(
                    width:300,
                    child:Text("I am good at managing the many responsibilities of my daily life.",style:TextStyle(fontSize:16,fontFamily:'Comforta'),textAlign: TextAlign.center,)
                ),
              ...
              GradientBorderButton(btnName: "Strongly Agree",
                callBack: (){
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) =>Activity_page10()
                      ));
                },),
