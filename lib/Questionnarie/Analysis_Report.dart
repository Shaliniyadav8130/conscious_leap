           ...
           Column(
             children:  List.generate(categoryPercentages.length, (index) {
               ...
               if (index == 0) {
                 ...
                 categoryImage = 'assets/images/Therapy.png';
                           ...
                           child: Row(
                             children: [
                               ...
                               Container(
                                 ...
                                 child: Text('${percentage.toStringAsFixed(2)}%',style: TextStyle(fontSize: 18,color:Color(0xff4961AC) ,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                               ),
                                 ...
                                 children: [
                                   Center(
                                     child:Padding(
                                       ...
                                       child:Text("${categoryName}",style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),),
                                     ),
                                   ...
                                   Center(
                                     child:SizedBox(
                                       width: 180,
                                       child:Text("${categoryText}",style: TextStyle(fontSize: 8),textAlign: TextAlign.center,),
                                     ),
