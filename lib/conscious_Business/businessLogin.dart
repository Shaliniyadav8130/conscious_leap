          ...
          child:Column(
            ...
            children: [
              Center(
                ...
                child:Text("Begin your Mindful Journey",style:TextStyle(fontSize: 24,fontFamily: "Comforta",color: Color(0xff4961AC),fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
              ),
              ),
              ...
              Center(
                child:Text("Business Login",style:TextStyle(fontSize: 25,fontFamily: "Comforta",color: Color(0xff4961AC),fontWeight: FontWeight.bold)),
              ),
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) =>BusinessOptions()
                          ));
                    },
                  ),
                ),
