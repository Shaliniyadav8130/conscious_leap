                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Sagrikaa Rastogi",style: TextStyle(fontSize: 13,fontFamily: 'Comforta',color: Color(0xff4961AC)),),
                        Text("Counselling Psychologist, M.A",style: TextStyle(fontSize: 13,fontFamily: 'Comforta',color: Colors.black),),
                        Text("3+ Years of experience",style: TextStyle(fontSize: 13,fontFamily: 'Comforta',color: Colors.black),),
                        Padding(padding: EdgeInsets.only(top:3,bottom: 3),
                          child:Text("Expertise",style: TextStyle(fontSize: 13,fontFamily: 'Comforta',color: Color(0xff4961AC)),),
                        ),
                        Text("\u2022 Anxiety",style: TextStyle(fontSize: 13,fontFamily: 'Comforta',color: Colors.black),),
                        Text("\u2022 Emotional Distress",style: TextStyle(fontSize: 13,fontFamily: 'Comforta',color: Colors.black),),
                        Text("\u2022 Trauma",style: TextStyle(fontSize: 13,fontFamily: 'Comforta',color: Colors.black),),
                        Text("\u2022 Stress",style: TextStyle(fontSize: 13,fontFamily: 'Comforta',color: Colors.black),),
                        Text("\u2022 Productivity Concerns",style: TextStyle(fontSize: 13,fontFamily: 'Comforta',color: Colors.black),),
                      ],
                    ),
                  ),
