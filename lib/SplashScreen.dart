...
class _QuestionnaireScreenState extends State<QuestionnaireScreen> {
  ...
  List<List<Map<String, dynamic>>> ratings = [
    ...
    // [
    //   {'option': 'Option 1', 'rating': 1, 'reverse': false},
    //   {'option': 'Option 2', 'rating': 2, 'reverse': false},
    //   {'option': 'Option 3', 'rating': 3, 'reverse': false},
    //   {'option': 'Option 4', 'rating': 4, 'reverse': false},
    //   {'option': 'Option 5', 'rating': 5, 'reverse': false},
    //   {'option': 'Option 6', 'rating': 6, 'reverse': false},
    //   {'option': 'Option 7', 'rating': 7, 'reverse': false},
    // ],
    // [
    //   {'option': 'Option 1', 'rating': 1, 'reverse': false},
    //   {'option': 'Option 2', 'rating': 2, 'reverse': false},
  ...
  int getRandomRating() {
    ...
    return ratings[currentCategoryIndex][currentQuestionIndex]['rating'];
  }
